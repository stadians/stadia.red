declare type ProtoData = any & Array<ProtoData | number | string | boolean | null>;
...
declare class Spider {
    ...
    constructor(skus?: Record<Sku["sku"], Sku>, spidered?: Record<Sku["sku"], true>);
...
declare class CommonSku {
    ...
    constructor(app: string, sku: string, type: "game" | "addon" | "bundle" | "subscription", name: string);
    key(): string;
}
...
declare class Bundle extends CommonSku {
    ...
    constructor(app: string, sku: string, type: "bundle", name: string, skus: Array<string>);
}
declare class Subscription extends CommonSku {
    readonly type: "subscription";
    readonly skus: Array<string>;
    constructor(app: string, sku: string, type: "subscription", name: string, skus: Array<string>);
}
