...
export const main = async () => {
    document.head.appendChild(fragment(JSX.createElement("title", null, "stadia.observer"), JSX.createElement("link", { rel: "icon", href: "/illufinch-violetsky-edited@2x.png" })));
